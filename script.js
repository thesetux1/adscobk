...
// ═══════════════════════════════════════════════════════════════
const SEGMENTS = [
  { label: "Kayan aikin gona",         sub: "Tarakta Kyauta",      color: "green",  image: "assets/prize-cash-500k.png", isPrize: true },
  { label: "₦200,000",         sub: "Nasara Nan take",  color: "white",  image: "assets/prize-cash-200k.png", isPrize: true },
  { label: "₦50,000",          sub: "Sami kuɗi yanzu",      color: "green",  image: "assets/prize-cash-50k.png",  isPrize: true },
  { label: "₦10,000",          sub: "Kudin Kirat",  color: "white",  image: "assets/prize-airtime.png",   isPrize: true },
  { label: "₦1,000,000",       sub: "Samu kuɗi yanzu",   color: "green",  image: "assets/prize-data.png",      isPrize: true },
  { label: "₦500,000",         sub: "Kyautar Kuɗi",  color: "white", image: "assets/prize-iphone.png",    isPrize: true },
  { label: "Ƙarin Juyawa",       color: "green",  icon: "➜", isPrize: false },
  { label: "Sake Gwadawa",        color: "white",  icon: "↻", isPrize: false },
];
...
function restoreGame() {
  ...
  if (won) {
    ...
    spinBtn.textContent = `Juya Ka Ci Nasara (${spinCount}/3)`;
  }
}
...
function reset() {
  ...
  document.getElementById('spinBtn').textContent = 'Juya Ka Ci Nasara (0/3)';
  document.getElementById('result').classList.add('hidden');
